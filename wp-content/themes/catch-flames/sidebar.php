	...
	?>
        <div id="secondary" class="widget-area" role="complementary">
			...
			elseif ( is_active_sidebar( 'sidebar-1' ) ) {
				echo "before widget widget_text sidebar-1<br>";
				dynamic_sidebar( 'sidebar-1' );
				echo "after widget widget_text sidebar-1<br>";
			}
            else {
            ?>
                <aside class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <p>
                            <?php _e( 'This is the Primary Sidebar Widget Area if you are using a two or three column site layout option.', 'catch-flames' ); ?>
                        </p>
                        <p>
                            <?php printf( __( 'You can add content to this area by visiting your <a href="%s">Widgets Panel</a> and adding new widgets to this area.', 'catch-flames' ), admin_url( 'widgets.php' ) ); ?></p>
                    </div>
                </aside>
                <?php
            }
